...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('tempocepat/vendor/unisharp/laravel-filemanager/public/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ asset('/tempocepat/vendor/unisharp/laravel-filemanager/public/css/lfm.css') }}">
...
<script src="{{URL::asset('assets/scripts/jquery/jquery.min.js')}}"></script>
  ...
  <script src="{{ asset('tempocepat/vendor/unisharp/laravel-filemanager/public/js/cropper.min.js') }}"></script>
  <script src="{{ asset('tempocepat/vendor/unisharp/laravel-filemanager/public/js/jquery.form.min.js') }}"></script>
