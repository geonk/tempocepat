...
@section('dashboard-content')
	...
	{!! Form::open(
    	...
    	{!! Form::hidden('id', e($article->id), ['class'=>'form-control']) !!}
	    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
			{!! Form::label('title', 'Title', ['class'=>'col-md-4 control-label']) !!}
			<div class="col-md-6">
				{!! Form::text('title', e($article->title), ['class'=>'form-control']) !!}
	    ...
	    <div class="form-group{{ $errors->has('article') ? ' has-error' : '' }}">
			...
			<div class="col-md-6">
				{!! Form::textarea('article', e($article->article), ['class'=>'form-control']) !!}
	    ...
	    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
			...
			<img src="{{URL::to('/')}}/assets/img/blog/medium/{{ e($article->image) }}" alt="">
			{!! Form::hidden('filename', e($article->image), ['class'=>'form-control']) !!}
		</div>
		...
		<div class="form-group">
			<div class="col-md-4 col-md-offset-2">
				{!! Form::submit('Update this Article', ['class'=>'btn btn-primary']) !!}
			</div>
		</div>
    {!!Form::close() !!}
    {!! Form::open(
    	array(
    		'url'=>'blog/deleteinside',
    		'method'=>'POST',
