  ...
  <div class="container">
    <div class="main-wrapper">
      <div class="main-wrapper-card">
        ...
        <div id="part-wishlist" class="part part-center">
          <h2>wishlist</h2><span class="hr-block"></span>
          <ul>
            <li><a href="#"><span class="list"><span class="img-wrap"><img src="{{URL::asset('assets/img/m1.jpg')}}" alt=""></span><span class="name-wrap">black leather rocka nazination</span><span class="musician-wrap">TROOPZ</span><span class="act-time"><span class="small">Add to wishlist at</span><span>12 Maret 2016, 1.32 PM</span></span></span></a></li>
            <li><a href="#"><span class="list"><span class="img-wrap"><img src="{{URL::asset('assets/img/m2.jpg')}}" alt=""></span><span class="name-wrap">black leather rocka nazination pro</span><span class="musician-wrap">War Day</span><span class="act-time"><span class="small">Add to wishlist at</span><span>12 Maret 2016, 1.32 PM</span></span></span></a></li>
            <li><a href="#"><span class="list"><span class="img-wrap"><img src="{{URL::asset('assets/img/m3.jpg')}}" alt=""></span><span class="name-wrap">black leather rocka</span><span class="musician-wrap">HFFN</span><span class="act-time"><span class="small">Add to wishlist at</span><span>12 Maret 2016, 1.32 PM</span></span></span></a></li>
          </ul>
        </div>
