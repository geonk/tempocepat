            ...
            <section class="content">
              ...
              <div class="row">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img src="{{URL::to('/')}}/img/profiles/{{ $user->image }}"/>
                        </td>
                        <td>
                            {!! e($user->name) !!}
                        </td>
                        ...
                        <td>
                            <span class="comment-timestamp">{!! date('F d, Y', strtotime($user->created_at)) !!} <span class="orange-color">-</span> {!! date('G:i A', strtotime($user->created_at)) !!}</span>
                        </td>
                        <td>
                            <span style="display: inline-block;">
                                {!!Form::open(array('url' =>
                                   '/user/'.$user->id.'/edit', 'method'=>
                                   'GET')) !!}
