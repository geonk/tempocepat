            ...
            <section class="content">
              ...
              <div class="row">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img src="{{URL::to('/')}}/tempocepat/public/assets/img/market/store/small/{{ $store->image }}" alt="">
                        </td>
                        <td>
                            {!! e($store->name) !!}
                        </td>
                        ...
                        <td>
                            <span class="comment-timestamp">{!! date('F d, Y', strtotime($store->created_at)) !!} <span class="orange-color">-</span> {!! date('G:i A', strtotime($store->created_at)) !!}</span>
                        </td>
                        <td>
                            <span style="display: inline-block;">
                                {!!Form::open(array('url' =>
                                   '/store/'.$store->id.'/edit', 'method'=>
                                   'GET')) !!}
