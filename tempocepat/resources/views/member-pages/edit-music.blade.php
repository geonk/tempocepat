...
<div class="" id="page-content-wrapper">
    ...
    {!! Form::open(
        ...
        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                {!! Form::text('title', $music->title, ['class'=>'form-control']) !!}
        ...
        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                {!! Form::textarea('description', $music->description, ['class'=>'form-control']) !!}
        ...
        {!! Form::hidden('id', $music->id, ['class'=>'form-control']) !!}
        <div class="form-group">
            <div class="col-md-4 col-md-offset-2">
                {!! Form::submit('Update this Music', ['class'=>'btn btn-primary']) !!}
            </div>
        </div>
    {!!Form::close() !!}
    ...
    <div class="box-footer">
        {!! Form::open(array('url'=>
                                     'music/deleteinside', 'method'=>
                                     'POST', 'style'=>
                                     'display:inline;')) !!}
                                     <div class="form-group" style="margin:0;">
                                         {!! Form::token() !!}
                                         {!! Form::hidden('id', $music->id, array('class'=>
                                         'form-control')) !!}
